...
export default function ApprovedCertificates() {
  ...
  const fetchApprovedCertificates = async () => {
    try {
      setLoading(true);
      const res = await api.get('/university/approved-certificates');
      setCertificates(res.data || []);
    } catch (error) {
      toast.error('Failed to fetch approved certificates');
          ...
          <AnimateSection>
            <div style={{ 
              ...
              <p style={{ 
                ...
                History of all certificates that have been approved by your university
              </p>
              ...
              <div style={{ 
                ...
                <div style={{ 
                  ...
                  <h3 style={{ color: '#059669', fontSize: '24px', margin: '0 0 8px 0' }}>
                    {certificates.length}
                  </h3>
                  <p style={{ color: '#10b981', margin: 0 }}>Total Approved</p>
                </div>
              </div>
            </div>
          </AnimateSection>
            ...
            <div style={{ 
              ...
              {loading ? (
                <div style={{ textAlign: 'center', padding: '40px' }}>
                  <p style={{ color: '#94a3b8' }}>Loading approved certificates...</p>
                </div>
              ) : certificates.length === 0 ? (
                <div style={{ textAlign: 'center', padding: '40px' }}>
                  <p style={{ color: '#94a3b8' }}>No approved certificates found</p>
                </div>
              ) : (
